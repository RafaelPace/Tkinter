...
menu_frame.rowconfigure((0,1,2,3,4), weight = 1, uniform = 1)
...
menu_slider1.grid(row = 2, column = 0, rowspan = 2, sticky = 'nsew', pady = 30)
menu_slider2.grid(row = 2, column = 2, rowspan = 2, sticky = 'nsew', pady = 30)
...
main_label2 = ttk.Label(entry_frame2, text = 'label2', background = 'blue')
